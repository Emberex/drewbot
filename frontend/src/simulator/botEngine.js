angular.module('em-drewbot').factory('botEngine', ['simulatorConstants', 
   function(simulatorConstants) {
      ...
      instance.determineBaseAngleFromPosition = function(pos, baseArm, isLeft) {
         ...
         var points = instance.circleIntersectionPoints(baseArm.point, baseArm.length, pos, simulatorConstants.ARMLENGTH); // jshint ignore:line
      ...
      instance.circleIntersectionPoints = function(p1, p1Length, p2, p2Length) {
